...
private:
    ...
    unordered_set<string> people;                       // set of all vertex name (people names - assumed to be unique)
...
public:
    ...
    unordered_set<string> getPeople();                      // getter function for the people
    vector<pair<string, double>> sortInitialBalances();     // getter function for the leaderboards
