...
Interface::Interface(int width, int height, string title)
{
    ...
    /*TextBox text1(make_pair(0.2, 0.2), make_pair(150, 30), "a", frame.font, 3);
    TextBox text2(make_pair(0.2, 0.2), make_pair(150, 30), "b", frame.font, 3);
    TextBox text3(make_pair(0.2, 0.2), make_pair(150, 30), "c", frame.font, 3);
    TextBox text4(make_pair(0.2, 0.2), make_pair(150, 30), "d", frame.font, 3);
    TextBox text5(make_pair(0.2, 0.2), make_pair(150, 30), "e", frame.font, 3);
    scrollTextBoxes.push_back(text1);
    scrollTextBoxes.push_back(text2);
    scrollTextBoxes.push_back(text3);
    scrollTextBoxes.push_back(text4);
    scrollTextBoxes.push_back(text5);*/
}
